    ...
    <body>
      ...
      <div class="row">
           <div class="update">
            ...
            <form action="http://localhost:8080/ecommerce/updates" method="POST">
                    ...
                    <%
                        ...
                        while(ors.next())
                        {
                             %>
                                <label>Id</label>
                                <input type="text"  name="id" value="<%=ors.getString(1)%>" readonly>
                                <br>
                                <label>User Name<label>
                                <input type="text"  name="usr" value="<%=ors.getString(2)%>">
                                <br>
                                <label>Email<label>
                                <input type="text"  name="email" value="<%=ors.getString(3)%>">
                                <br>
                                <label>Phone Number<label>
                                <input type="text"  name="pno" value="<%=ors.getString(4)%>">
                                <br>
                                <label>Password<label>
                                <input type="text"  name="password" value="<%=ors.getString(5)%>">
