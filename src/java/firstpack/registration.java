...
public class registration extends HttpServlet {
    ...
    String vUserName,vMail,vP_No,vPassword,vConPassword;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            vMail=request.getParameter("tbMail");
            vP_No=request.getParameter("tbP_No");
            vPassword = request.getParameter("tbPassword");
            vConPassword = request.getParameter("tbConPassword");
            //STEP 1 : REGISTERING OF THE REQUIRED DRIVER WITH THE JAVA PROGRAM
                //Class.forName("oracle.jdbc.OracleDriver");
                DriverManager.registerDriver(new oracle.jdbc.OracleDriver());
            if(vPassword!= null && vConPassword != null && vPassword.equals(vConPassword)){
                ...
                String q = "INSERT INTO userss(usr,mail,p_no,password) values(?,?,?,?)";
                ...
                ost.setString(2,vMail);
                ost.setString(3,vP_No);
