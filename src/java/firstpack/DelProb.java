...
public class DelProb extends HttpServlet {

        String vFirstname,query;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DriverManager.registerDriver(new oracle.jdbc.OracleDriver());
                ...
                query = "delete from custprob where firstname = ?";
                ...
                vFirstname = request.getParameter("firstname");
       ...
       response.sendRedirect("http://localhost:8080/ecommerce/admindash.jsp");
                ...
                Logger.getLogger(DelProb.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
