...
<html>
    <head>
        ...
        <script >
            ...
            function checkImg()
            {
                if (document.getElementById('imgout').src === "http://localhost:8080/ecommerce/Pages/HTML%20Pages/null") //change this path to your project path
                {
    ...
    <body>
        <form style="color:blue" onsubmit="return validate()" method="POST" action="http://localhost:8080/ecommerce/ImgTestServlet" enctype="multipart/form-data">
            <div class="container">
                <h1>Add Product Details To Database</h1>
                <br>
                ...
                <div >
                    ...
                    <img id="imgout" width="170" height="235" src=null disabled/>
                    <br>
            ...
            <br>
                    ...
                    <form action="http://localhost:8080/ecommerce/ImgTestServlet" method="post">
