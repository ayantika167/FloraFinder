...
public final class productdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <span>\n");
      out.write("                <form method=\"POST\" action=\"productdetails.jsp\">\n");
      ...
      out.write("        ");
            ...
            if(request.getParameter("bSearch")!=null)
            {
                String vSearchUser = request.getParameter("tSearch");
                    ...
                    q = "select * from product where name=?";
      ...
      out.write("                    ");
            ...
            //STEP 4: CREATING THE QUERY
            q = "select * from product order by 1";
      ...
      out.write("            <form method=\"POST\" action=\"http://localhost:8080/ecommerce/DelImg?name=");
